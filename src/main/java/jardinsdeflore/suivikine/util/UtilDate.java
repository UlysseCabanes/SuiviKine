...
public class UtilDate {
    ...
    public static String getDateFormatyyyyMMdd(String dateParam) throws ParseException {
        //Jour = caractères aux index 0 et 1 du paramètre
        String jour = dateParam.substring(0,2);
        //Mois = caractères aux index 3 et 4 du paramètre
        String mois = dateParam.substring(3,5);
        //Annee = caractères aux index 6, 7, 8 et 9 du paramètre
        String annee = dateParam.substring(6);
    ...
    public static String getDateFormatddMMyyyy(String dateParam) throws ParseException {
        //Jour = caractères aux index 8 et 9 du paramètre
        String jour = dateParam.substring(8);
        //Mois = caractères aux index 5 et 6 du paramètre
        String mois = dateParam.substring(5,7);
        //Annee = caractères aux index 0, 1, 2 et 3 du paramètre
        String annee = dateParam.substring(0,4);
